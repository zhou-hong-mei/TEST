...
<!-- https://ext.dcloud.net.cn/plugin?id=1256 -->
<script>
export default {
	data() {
		return {
				...
				case 'video':
					uni.chooseVideo({
						...
						success: async (res) => {
							...
							// console.log(res);
							this.$emit('sonMp4',res.tempFilePath);
