    ...
    <view class="mpvue-picker">
        ...
        <view class="mpvue-picker-content " :class="{'mpvue-picker-view-show':showPicker}">
            <view class="mpvue-picker__hd" catchtouchmove="true">
                <view class="mpvue-picker__action" @click="pickerCancel">{{i18n.text187}}</view>
                <view class="mpvue-picker__action" :style="{color:themeColor}" @click="pickerConfirm">{{i18n.text188}}</view>
            </view>
            <!-- 单列 -->
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange"
                v-if="mode==='selectorCity' && pickerValueSingleArray.length > 0">
                <block>
                    <picker-view-column>
                        <view class="picker-item" v-for="(item,index) in pickerValueSingleArray" :key="index">{{item.name}}</view>
                    </picker-view-column>
            ...
            <picker-view indicator-style="height: 40px;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange"
                v-if="mode==='selector1' && pickerValueSingleArray.length > 0">
                <block>
                    <picker-view-column>
    ...
    export default {
        ...
        methods: {
            initPicker(valueArray) {
                ...
                // 初始化多级联动
                if (this.mode === 'selector' || this.mode === 'selector1' || this.mode === 'selectorCity') {
